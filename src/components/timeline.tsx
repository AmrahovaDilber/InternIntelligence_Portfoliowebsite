      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-12">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-8 ml-20 lg:ml-0 sm:pl-12 py-8 w-full backdrop-blur-lg bg-black bg-opacity-40 rounded-lg">
              <h3 className="md:hidden block sm:text-2xl mb-4 text-left font-bold  text-lg text-neutral-500">
                {item.title}
              </h3>
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[4px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-white to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0 w-[6px]  bg-purple-500 rounded-full"
          />
        </div>
      </div>
    </div>
